                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('usuario.store') }}">
                        ...
                        <div class="form-group{{ $errors->has('nome') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="nome" value="{{ old('nome') }}" autofocus>
                        ...
                        <div class="form-group{{ $errors->has('senha-confirm') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" type="password" class="form-control" name="senha-confirm" >
